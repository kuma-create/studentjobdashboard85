...
export default function ApplicationDetailClient({ application }: ApplicationDetailClientProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="mb-6">
        <Button variant="ghost" className="mb-2 gap-1 pl-0" onClick={() => router.push("/applications")}>
          ...
          <Card>
            <CardHeader className="p-4">
              <div className="flex items-center gap-3">
                <div className="relative h-12 w-12 overflow-hidden rounded-md">
                  <Image
                    src={application.jobs.companies.logo_url || "/placeholder.svg?height=48&width=48&query=company"}
            ...
            <CardContent className="p-4 pt-0">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>{application.jobs.work_style}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Calendar className="h-4 w-4 text-gray-400" />
                  <span>
                    応募締切:{" "}
                    {format(new Date(application.jobs.application_deadline), "yyyy年MM月dd日", { locale: ja })}
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <h4 className="text-sm font-medium">企業情報</h4>
            ...
            <CardFooter className="flex justify-between border-t p-4">
              ...
              <Button
                ...
                onClick={() => router.push(`/chat/${application.jobs.companies.id}`)}
              >
        ...
        <DialogContent>
          ...
          <div className="py-4">
            <div className="rounded-md border p-4">
              ...
              <div className="text-sm text-gray-500">{application.jobs.companies.name}</div>
            </div>
          </div>
          <DialogFooter>
